...
--	HB_SPELL_PATTERN_REJUVENATION2 = "Not needed for en";
	...
	HB_OFFLINE = "오프라인"; -- has gone offline msg
	HB_ONLINE = "온라인"; -- has come online msg
	...
	HEALBOT_OPTIONS_SKINFHEIGHT = "글자 크기"
	...
	HEALBOT_OPTIONS_CDCBARS = "생명력 바 색상";
...
--	HEALBOT_EIGHT = "8";
	...
	HEALBOT_SKIN_HEADERTEXTCOL = "글자 색상";
